...
// Max Xue z5267325
// Program uses Dijkstra's Algorithm to find the shortest path between verticies
// and stores all predecessor vertecies that produce the shortest path in 
// linked list.
...
ShortestPaths dijkstra(Graph g, Vertex src) {
	...
	// Used 2521 Lecture Slides: Lecture 7.4 Page 7 for Algorithm Below
	
	// From this point forward, when the term EXPLORE is used, it 
